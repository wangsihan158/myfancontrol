贴吧大神作品myfancontrol个人续作，原贴请见 https://tieba.baidu.com/p/5971634018?red_tag=1969604114，原仓库请见 https://github.com/xl-Synapse/MyFanControl
因个人使用需求给软件加了些许内容，欢迎有人来使用，有bug请积极反馈。
## 使用说明
...
## 更新说明
	...
	1. 加入软性控制，防止风扇转速突然增加或减小。
	2. 加入GPU显存偏移
	3. 八个温度档位现在是可调节的
	4. 软件启动时改为默认高级模式
	5. 时间计算方式改为Windows 内核管理定时器队列，防止高负载下软件内部计时器被延长
	6. 修正了托盘图标的bug，现在重启资源管理器托盘图标不会消失

	
	因为我本人没太研究明白nvgpu.dll的显存控制逻辑，所以显存频率偏移会有点bug，如果有明白的大佬请多多指教。
